...
else
{
	...
	VALUES ('$emel','$idNama','$nama','$kataLaluan','pengguna')");
	if($query)
	{
...
<h1>Pendaftaran Pentadbir</h1>
<br>
<b>Sudah Berdaftar? <a href="logmasuk.php">Log Masuk Sekarang</a></b><br><br>
...
<input class="button button2" name="submit" type="submit" value="Daftar"/><br><br>
</form>
</div>
</center>
</body>
